...
import ExamNotFound from "../../../components/activities/examDetails/ExamNotFound";
import LoadingExamDetails from "../../../components/common/loading/LoadingExamDetails";
...
const CompletedExamSubmissionDetail = () => {
  ...
  useEffect(() => {
    const fetchExamSubmissionData = async () => {
      try {
        ...
        const totalQuestions = data.examData.length;
  ...
  return (
    <div className="p-5 flex flex-col">
      <Navbar />
      <main className="container mx-auto px-2 pt-4 pb-8 flex flex-col gap-2">
        ...
        <div
          ref={certificateRef}
          className="bg-white rounded-xl shadow-2xs border border-gray-100 mb-8 overflow-hidden"
        >
          <div className="bg-gradient-to-r from-green-50 to-indigo-50 p-8 text-center relative">
              ...
              <div className="max-w-2xl mx-auto bg-white rounded-xl border border-gray-200 shadow-2xs p-8 mb-6">
                <div className="text-center mb-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-1 capitalize">
                    {examData.examId.subject?.name}:{" "}
                    {examData.examId.subTopicName}
                  </h2>
                  <p className="text-gray-600">
                    Order {examData.examId.order} | Code:{" "}
                    {examData.examId.examCode} |{" "}
                    {formatDuration(examData?.timetaken)} to Complete
                  </p>
                </div>
                ...
                <div className="text-center text-gray-500 text-sm">
                  <p>
                    ...
                    has demonstrated proficiency in the subject matter and has
                    met all requirements for completion.
                  </p>
                </div>
              </div>
              {!hideButtons && (
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button
                    ...
                    className="px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-medium hover:border-indigo-600 hover:text-indigo-600 transition-colors flex items-center justify-center gap-2 cursor-pointer"
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-8 gap-6 mb-8">
          <div className="md:col-span-8 bg-white rounded-xl shadow-2xs border border-gray-100 p-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-4">
                ...
                <div className="space-y-4 max-h-48 overflow-y-auto pr-2">
                  {examData.reviews.map((review, index) => (
                    <div key={review._id} className="bg-white rounded-xl p-3">
...
export default CompletedExamSubmissionDetail;
